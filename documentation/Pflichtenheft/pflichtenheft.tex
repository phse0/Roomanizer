...
\section{Einführung}
\subsection{Projekt}
Projektziel ist es ein EDV - System für ein Hotel, Roomanizer genannt, zu entwickeln, welches folgende Funktion anbietet:
\begin{itemize}
	\item Reservierung
	\item Check - In
	\item Check - Out
...
\paragraph{Anforderung an das Pflichtenheft\\*}
 Das Pflichtenheft beschreibt alle Anforderung welche im Roomanizer enthalten sein müssen. Bei Abschluss des Projektes wird jede hier definierte Funktion von der Software bereitgestellt.

\paragraph{Bereiche\\*}
Die Bereiche des Pflichtenheftes zeigen die Arbeitsprozesse welche vom System unterstützt werden. Die Prozesse werden schriftlich und mit Hilfe von Diagrammen dargestellt.

\paragraph{Quellen}
\begin{itemize}
\item Projektbeschreibung Roomanizer
\item Requirements Workshop Protokoll
\end{itemize}
