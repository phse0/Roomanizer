...
\newglossaryentry{Kunde}{name=Kunde, description={Eine Person, die zum Beispiel bereits eine Reservierung gemacht hat, aber noch nicht im Hotel eingecheckt hat}}
